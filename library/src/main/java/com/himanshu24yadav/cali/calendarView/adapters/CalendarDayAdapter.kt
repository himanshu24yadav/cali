package com.himanshu24yadav.cali.calendarView.adapters
...
import com.himanshu24yadav.cali.calendarView.exceptions.InvalidCustomLayoutException
import com.himanshu24yadav.cali.calendarView.CalenderView
import com.himanshu24yadav.cali.calendarView.utils.*
import com.himanshu24yadav.cali.calendarView.utils.isEventDayWithLabelColor
import com.himanshu24yadav.cali.calendarView.utils.loadImage
import com.himanshu24yadav.cali.calendarView.utils.setCurrentMonthDayColors
import com.himanshu24yadav.cali.calendarView.utils.setSelectedDayColors
 ...
 * Created by Himanshu
 */
class CalendarDayAdapter(context: Context, private val calendarPageAdapter: CalendarPageAdapter, private val calendarProperties: CalendarProperties, dates: MutableList<Date>, pageMonth: Int)
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        val dayView = view ?: LayoutInflater.from(context).inflate(calendarProperties.itemLayoutResource, parent, false)

        val day = GregorianCalendar().apply { time = getItem(position) ?: calendarProperties.calendar?.time ?: Date() }
    ...
    private fun setLabelColors(dayLabel: TextView, day: Calendar) {
        when {
            ...
            day.isSelectedDay() -> {
                calendarPageAdapter.selectedDays.firstOrNull { selectedDay -> selectedDay.calendar == day }?.let { selectedDay -> selectedDay.view = dayLabel }
    ...
    private fun Calendar.isSelectedDay() = calendarProperties.calendarType != CalenderView.CLASSIC
