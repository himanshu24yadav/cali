...
import com.himanshu24yadav.cali.calendarView.extensions.CalendarGridView
import com.himanshu24yadav.cali.calendarView.listeners.DayRowClickListener
import com.himanshu24yadav.cali.calendarView.listeners.DayRowLongClickListener
import com.himanshu24yadav.cali.calendarView.utils.CalendarProperties
import com.himanshu24yadav.cali.calendarView.utils.SelectedDay
import com.himanshu24yadav.cali.calendarView.utils.CalendarProperties.Companion.MAX_CELLS_COUNT_MONTH
import java.util.*
 ...
 * Created by Himanshu
 */
class CalendarPageAdapter(private val context: Context, private val calendarProperties: CalendarProperties) : PagerAdapter() {
    ...
    private fun loadMonth(position: Int) {
         ...
         */
        while (days.size < MAX_CELLS_COUNT_MONTH) {
